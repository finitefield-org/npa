...
mod tests {
    ...
    fn canonical_term_source_fixture_for_ai_fast_path_is_stable() {
        ...
        let expected_bytes = vec![
            0x21, 0x6e, 0x70, 0x61, 0x2e, 0x70, 0x68, 0x61, 0x73, 0x65, 0x33, 0x2e, 0x6d, 0x61,
            0x63, 0x68, 0x69, 0x6e, 0x65, 0x2d, 0x74, 0x65, 0x72, 0x6d, 0x2d, 0x73, 0x6f, 0x75,
            0x72, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x03, 0x03, 0x00, 0x02, 0x02, 0x45, 0x71, 0x04,
            0x72, 0x65, 0x66, 0x6c, 0x01, 0x01, 0x01, 0x00, 0x01, 0x00, 0x01, 0x03, 0x4e, 0x61,
            0x74, 0x00, 0x00, 0x00, 0x01, 0x01, 0x6e, 0x00, 0x00,
        ];
        let expected_hash = [
