...
pub use human::{
    ...
    run_human_intro_tactic, run_human_rewrite_tactic, run_human_tactic_script, start_human_proof,
};
pub use json::{
...
pub use types::{
    ...
    HumanRewriteTacticError, HumanRewriteTacticOk, HumanRewriteTacticRequest, HumanStartProofError,
