...
pub use phase9::{
    ...
    phase9_quotient_candidate_canonical_bytes, phase9_theorem_graph_query_canonical_bytes,
    ...
    Phase9MachineQuotientOperationCandidate, Phase9MachineTelescopeBinder,
    ...
    Phase9SmtCertificateError, Phase9SmtOptions, Phase9TheoremGraphEdgeKind,
