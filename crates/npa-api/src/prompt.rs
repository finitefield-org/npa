...
use crate::search::{
    ...
    parse_theorem_modes, select_machine_theorem_results_for_goal, MachineTheoremFilters,
    MachineTheoremGlobalRef, MachineTheoremMode, MachineTheoremSearchResult,
    MachineTheoremStatement, SEARCH_PROFILE_VERSION, SUGGESTION_PROFILE_VERSION,
};
...
fn build_machine_prompt_payload_parsed(
    ...
    let premises = selection
        .results
        .into_iter()
        .map(prompt_premise_from_search_result)
        .collect::<Vec<_>>();
    ...
    let payload_fingerprint = prompt_payload_fingerprint(PromptPayloadFingerprintInput {
        ...
        premise_query_fingerprint: selection.query_fingerprint,
...
fn prompt_premise_from_search_result(result: MachineTheoremSearchResult) -> MachinePromptPremise {
    MachinePromptPremise {
        premise_id: result.premise_id,
        global_ref: result.global_ref,
        universe_params: result.universe_params,
