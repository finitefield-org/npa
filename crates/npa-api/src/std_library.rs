...
///
/// The profile treats source files as source-package skeletons that fix module
/// membership and import intent. Certificate contents are generated by the
/// deterministic Rust core-module builders below.
