...
implementation planning live in [develop/](../develop/README.md).
...
- [GitHub Actions CI Templates](../ci-templates/github-actions/README.md):
  copyable package workflow templates.
...
These fixtures are useful as public package examples:

- [npa-std fixture](../fixtures/npa-std/README.md): local standard-library
...
- [Toolchain Reference v0.1.0](npa-toolchain-reference-v0.1.0.md): historical
  SRA-01 reference retained for audit context. Use v0.1.1 as the current
