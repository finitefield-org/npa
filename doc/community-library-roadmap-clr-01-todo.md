...
Source: `doc/community-library-roadmap-todo.md` CLR-01
...
- Inputs:
  ...
  - validator cases listed in `doc/community-library-roadmap-clr-00-todo.md`
- Code or documentation areas:
...
- Code or documentation areas:
  - `crates/npa-package/src/lib.rs`
  - package docs under `doc/` if the implementation creates one
  - `doc/community-library-roadmap-clr-01-todo.md` if task status is updated during implementation
- Deliverables:
...
- Code or documentation areas:
  ...
  - `doc/community-library-roadmap-clr-01-todo.md`
...
Review against `doc/community-library-roadmap-todo.md`, `doc/community-library-roadmap-clr-00-todo.md`,
...
```sh
git diff --check
rg -n "TO""DO|TB""D|未""定|PLACE""HOLDER" doc/community-library-roadmap-clr-01-todo.md
rg -n "npa-package|npa.package.v0.1|trusted_status|expected_source_hash|expected_certificate_file_hash|unknown_field|import_cycle|registry lookup" \
  doc/community-library-roadmap-clr-01-todo.md doc/community-library-roadmap-clr-00-todo.md doc/community-library-roadmap-todo.md
```
