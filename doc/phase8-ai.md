...
- CompareValidationResult and AuditSidecarValidationResult response error objects allow field / expected_value / actual_value / expected_hash / actual_hash payload fields and reject only fields outside the fixed payload set
