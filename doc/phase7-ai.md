...
```text
0. Phase 5 Machine API boundary
   /machine/snapshots/get, /machine/search/for_goal, /machine/tactics/batch,
   /machine/replay, /machine/verify の contract を満たす client を用意する
   Phase 5 未実装時の fake は同じ contract のテスト double に限定する
