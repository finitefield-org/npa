...
OCaml project はこの `npa` repository 内に置きます。別 repository には分離しません。
...
```text
- OCaml project の exact in-repository directory
- vendored SHA-256 implementation の exact in-repository file layout
