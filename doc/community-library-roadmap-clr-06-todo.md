...
Source: `doc/community-library-roadmap-todo.md` CLR-06
...
- Inputs:
  ...
  - `doc/community-library-roadmap-todo.md` CLR-06
...
- Verification:
  ...
  - `rg -n "npa.package.publish_plan.v0.1|npa.registry.module.v0.1|checker_binary_registry" crates/npa-package doc/community-library-roadmap-clr-06-todo.md`
- Notes:
...
- Verification:
  ...
  - `rg -n "checksum-only|signature_required|generated/publish-plan.json" crates/npa-package doc/community-library-roadmap-clr-06-todo.md`
- Notes:
...
- Verification:
  ...
  - `rg -n "npa.registry.module.v0.1|checker_binary_registry" crates doc/community-library-roadmap-clr-06-todo.md`
- Notes:
...
- Verification:
  ...
  - `rg -n "downstream_import_bundle|latest|registry_url" crates/npa-package doc/community-library-roadmap-clr-06-todo.md`
- Notes:
