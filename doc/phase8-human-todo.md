...
次はまだ target integration として残します。README と `doc/phase8-human.md` では、これらを
...
standalone `npa-checker-ext` binary、verified_high_trust artifact、full external-checker release audit CI は
この MVP の後続 target integration です。
