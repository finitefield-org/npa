...
- Status: Completed
- Deliverables:
  - A short classification table in `docs/README.md` or `docs/index.md`.
...
- Public-facing docs should include:
  ...
  - `docs/npa-toolchain-reference-v0.1.1.md`
...
- Evidence fixed on 2026-06-02:
  - Added `docs/README.md` as the public/internal documentation classification
    page.
...
- Evidence fixed on 2026-06-02:
  ...
  - Updated `docs/README.md` to mark the public repository entry contribution
...
- Evidence fixed on 2026-06-02:
  - Expanded `docs/README.md` from a classification page into the English
    documentation index.
  ...
  - Updated root `README.md` to route internal planning, release evidence, and
    Japanese development notes through `docs/README.md` instead of linking them
    directly.
...
- Status: Completed
- Inputs:
  - `docs/npa-toolchain-reference-v0.1.0.md`
  - `docs/npa-toolchain-reference-v0.1.1.md`
- Deliverables:
...
- Evidence fixed on 2026-06-02:
  - Marked `docs/npa-toolchain-reference-v0.1.1.md` as the current
    SRA-02-compatible package-author ref.
  - Marked `docs/npa-toolchain-reference-v0.1.0.md` as historical and
...
- Evidence fixed on 2026-06-02:
  - Rewrote `docs/external-theorem-library-ci.md` as an English package-author
    CI guide.
...
- Evidence fixed on 2026-06-02:
  ...
  - Updated `docs/README.md` to mark external checker docs as cleaned in PUB-08
...
- Evidence fixed on 2026-06-02:
  ...
  - Marked `fixtures/npa-mathlib-seed/**` README/CONTRIBUTING notes,
    ...
    points.
  - Updated `docs/README.md` with explicit public-example and internal-fixture
    lists.
...
- Evidence fixed on 2026-06-02:
  - Added `docs/index.md` as an English alias for `docs/README.md` so the
