...
Source: `develop/community-library-roadmap-todo.md` CLR-05
...
- Inputs:
  ...
  - `develop/community-library-roadmap-todo.md` CLR-05
...
- Verification:
  ...
  - `rg -n "npa.package.axiom_report.v0.1|npa.package.theorem_index.v0.1" crates/npa-package develop/community-library-roadmap-clr-05-todo.md`
- Notes:
