...
この TODO は `develop/phase3-human.md` を正とし、現在の `crates/npa-frontend` /
...
`develop/phase3-human.md` が要求する以下の機能は、現在のコードには Human Surface として存在しません。
...
```text
- `develop/phase3-human.md` 12.1 から 12.15 の parser 部分を parse できる
...
- [x] `develop/phase3-human.md` の設計と実装済み範囲がずれた場合は更新する。
- [x] `develop/phase3-ai.md` に Machine Surface 高速経路の非回帰条件を維持する。
