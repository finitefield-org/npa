...
Source: `develop/community-library-roadmap-todo.md` CLR-07
...
- Depends on: CLR-05
- Inputs:
  - `develop/community-library-roadmap-todo.md` CLR-07
  - `develop/community-library-roadmap.md` section 5.3 and M3
...
- Verification:
  - `rg -n "NPA_VERSION|npa --version|latest|registry|hidden package cache" ci-templates docs/external-theorem-library-ci.md`
  - `git diff --check`
- Notes:
...
- Verification:
  - `rg -n "source_hash_mismatch|certificate_hash_mismatch|axiom_report|theorem_index|reason_code|not proof evidence" docs/external-theorem-library-ci.md ci-templates`
  - `git diff --check`
- Notes:
