...
- Public `npa-mathlib` namespace policy, standalone repository activation,
  ...
  evidence, Layer 3D-A kernel/image release evidence, and Layer 3D-B kernel
  quotient release evidence are now fixed. Larger theorem layers, release
...
`npa-mathlib v0.1.8` Layer 3D-B kernel quotient release continuation.
...
- GitHub Actions status for `npa-mathlib v0.1.1`, `v0.1.2`, `v0.1.3`,
  `v0.1.4`, `v0.1.5`, `v0.1.6`, `v0.1.7`, and `v0.1.8` was intentionally
  ignored.
...
- Broader theorem layers beyond the released Layer 3D-B kernel quotient set
...
## Public Layer 3D-B Release Facts

The standalone `npa-mathlib v0.1.8` generated publish plan records:

- schema: `npa.package.publish_plan.v0.1`
- package: `npa-mathlib`
- version: `0.1.8`
- release artifact count: 28
- module registry seed entry count: 22
- downstream import bundle module count: 22
- checker summary count: 48
- signature policy: `checksum-only`
- hash algorithm: `sha256`
- signatures: empty
- publish plan hash:
  `sha256:93883dcf8b42e6013fb416f414a905f80a263bd17e8f50f5fc68017730a73058`

The standalone `npa-mathlib v0.1.8` generated artifacts also record:

- package lock entries: 24
- theorem index entries: 238
- theorem index checker summaries: 24
- axiom report modules: 24
- axiom report local modules: 22
- axiom report external modules: 2
- direct axiom count: 1
- transitive axiom count: 9
- policy violation count: 0
- allowed axioms: `Eq.rec`

The standalone `fixtures/downstream-smoke/generated/package-lock.json` records
one local downstream module, `Downstream.GroupKernelQuotient`, and these
external imported modules:
