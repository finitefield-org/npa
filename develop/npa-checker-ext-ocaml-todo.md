...
Source: `develop/npa-checker-ext-ocaml.md`
...
- Depends on: None
- Inputs:
  - `develop/npa-checker-ext-ocaml.md` sections 1, 3, 4, 7, 11, 12, 14, 16
  - `develop/phase8-ai.md` RunnerPolicy / CheckerBinaryRegistry / raw result sections
...
2. Record the decision in develop/npa-checker-ext-ocaml.md section 16.
...
```sh
git diff --check
rg -n "npa-checker-ext|OCaml project|in-repository" develop/npa-checker-ext-ocaml.md develop/npa-checker-ext-ocaml-todo.md
```
...
- Depends on: M0
- Inputs:
  - `develop/npa-checker-ext-ocaml.md` sections 5 and 6
  - `develop/phase2.md`
...
```sh
sh checkers/npa-checker-ext/scripts/test.sh decoder-reachability
```
...
- Depends on: M1
- Inputs:
  - `develop/npa-checker-ext-ocaml.md` section 7
...
- Depends on: M2
- Inputs:
  - `develop/npa-checker-ext-ocaml.md` section 8
  - `develop/phase8-ai.md` import lock and runner policy sections
...
- Inputs:
  - `develop/core-spec-v0.1.md`
  - `develop/phase0.md`
  - `develop/npa-checker-ext-ocaml.md` section 9
...
- Depends on: M4
- Inputs:
  - `develop/core-spec-v0.1.md` conversion rules
  - `develop/npa-checker-ext-ocaml.md` section 9
...
- Depends on: M5
- Inputs:
  - `develop/core-spec-v0.1.md` inductive sections
  - `develop/phase0.md` inductive declaration rules
  - `develop/npa-checker-ext-ocaml.md` section 9
...
- Depends on: M6
- Inputs:
  - `develop/npa-checker-ext-ocaml.md` section 10
  - `develop/phase8-human.md` axiom policy sections
  - `develop/phase8-ai.md` axiom report artifact sections
...
- Depends on: M7
- Inputs:
  - `develop/npa-checker-ext-ocaml.md` sections 4, 5, 11, 15
  - `develop/community-library-roadmap-clr-08-todo.md`
  - `develop/phase8-ai.md` raw result, MachineCheckResult, registry, and
...
rg -n "npa-checker-ext|checker_identity|binary_hash" crates/npa-api/src/independent_checker.rs develop/phase8-ai.md
```
