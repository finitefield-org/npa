...
Source: `develop/community-library-roadmap-todo.md` CLR-00
...
- Depends on: None
- Inputs:
  - `develop/community-library-roadmap-todo.md` CLR-00
  - root `Cargo.toml`
...
- Verification:
  - `rg -n "PACKAGE_""CLI_CRATE|npa-cli|npa package" develop/community-library-roadmap-todo.md develop/community-library-roadmap-clr-00-todo.md README.md`
  - `git diff --check`
- Notes:
...
- Inputs:
  ...
  - registry sketch in `develop/community-library-roadmap.md`
- Deliverables:
...
- Verification:
  - `rg -n "npa\\.package\\.|independent-checker\\.import_lock|npa\\.registry\\.module\\.v0\\.1" develop/community-library-roadmap-clr-00-todo.md develop/community-library-roadmap.md develop/phase8-ai.md`
  - `git diff --check`
- Notes:
...
- Inputs:
  - `develop/community-library-roadmap.md` section 5.1
...
- Verification:
  - `rg -n "expected_source_hash|expected_certificate_file_hash|trusted_status|proofs/npa-package.toml" develop/community-library-roadmap-clr-00-todo.md develop/community-library-roadmap-todo.md`
  - `git diff --check`
- Notes:
...
- Inputs:
  ...
  - `develop/community-library-roadmap-todo.md` CLR-02
- Deliverables:
...
- Verification:
  - `rg -n "npa-ai-proof-corpus-v0.1|expected_export_hash|expected_axiom_report_hash|trusted_status" develop/community-library-roadmap-clr-00-todo.md proofs/manifest.toml`
  - `git diff --check`
- Notes:
...
- Verification:
  - `rg -n "module name alone|same-package import|external import|registry lookup" develop/community-library-roadmap-clr-00-todo.md develop/community-library-roadmap.md develop/phase4-ai.md develop/phase8-ai.md`
  - `git diff --check`
- Notes:
...
- Verification:
  - `rg -n "schema failure|domain failure|duplicate|import cycle|hash grammar|axiom policy" develop/community-library-roadmap-clr-00-todo.md`
  - `git diff --check`
- Notes:
...
- Verification:
  - `git diff --check`
  - `rg -n "npa package|npa-cli|npa\\.package\\.v0\\.1|npa.package.lock.v0.1|trusted_status|registry lookup" develop/community-library-roadmap-clr-00-todo.md develop/community-library-roadmap-todo.md`
- Notes:
...
Review against `develop/community-library-roadmap.md`, `develop/community-library-roadmap-todo.md`,
