...
Source: `develop/community-library-roadmap-todo.md` CLR-02
...
- Code or documentation areas:
  - `tools/proof-corpus/src/main.rs`
  - `develop/community-library-roadmap-clr-02-todo.md` if the audit changes known facts
- Deliverables:
...
- Inputs:
  - `proofs/npa-package.toml`
  - `develop/community-library-roadmap-todo.md` CLR-03
...
- Notes:
  ...
  - Added CLR-03 handoff notes to `develop/community-library-roadmap-todo.md` and
    `proofs/README.md`.
