...
| `MEA-03` | outer measure laws, Caratheodory criterion, premeasure, semiring/ring/algebra extension evidence, extension uniqueness via pi-lambda or monotone-class tools | `MEA-01` monotone-class tools, `MEA-02` for restriction measure | source-free module verify or construction-interface audit |
