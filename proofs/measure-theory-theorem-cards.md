...
| `MEA-01` | `sigma_algebras_measurable_spaces` | `L1` then `L2` | `MEA-T02` through `MEA-T05` | `Proofs.Ai.Measure.SigmaAlgebra`, `Proofs.Ai.Measure.MeasurableSpace`, `Proofs.Ai.Measure.MonotoneClass` | foundation |
...
| `MEA-04` | `lebesgue_stieltjes_measures` | `L1` first | `MEA-T13` through `MEA-T15` | `Proofs.Ai.Measure.Lebesgue`, `Proofs.Ai.Measure.Stieltjes` | construction interface |
...
| `MEA-08` | `product_measures_fubini_tonelli` | `L2` after product and integral foundations | `MEA-T26` through `MEA-T29` | `Proofs.Ai.Measure.Product`, `Proofs.Ai.Measure.Fubini` | derived theorem |
| `MEA-09` | `pushforwards_change_of_variables` | `L2` where prerequisites exist | `MEA-T30` through `MEA-T32` | `Proofs.Ai.Measure.Pushforward`, `Proofs.Ai.Measure.ChangeOfVariables` | derived theorem |
| `MEA-10` | `signed_complex_decomposed_measures` | `L1` then `L2` | `MEA-T33` through `MEA-T36` | `Proofs.Ai.Measure.Signed`, `Proofs.Ai.Measure.Decomposition`, `Proofs.Ai.Measure.RadonNikodym` | derived theorem |
| `MEA-11` | `lebesgue_regularity_differentiation` | `L1` first | `MEA-T37` through `MEA-T39` | `Proofs.Ai.Measure.Regularity`, `Proofs.Ai.Measure.Differentiation` | derived theorem |
| `MEA-12` | `lp_spaces_inequalities` | `L2` after integral and norm foundations | `MEA-T40` through `MEA-T43` | `Proofs.Ai.Measure.Lp`, analysis and functional-analysis aliases | derived theorem |
| `MEA-13` | `topological_measures_weak_convergence` | `L1` first | `MEA-T44` through `MEA-T47` | `Proofs.Ai.Measure.Borel`, `Proofs.Ai.Measure.Radon`, `Proofs.Ai.Measure.WeakConvergence` | specialization |
| `MEA-14` | `probability_martingale_ergodic_bridges` | `L1` first | `MEA-T48` through `MEA-T51` | probability and ergodic aliases over `Proofs.Ai.Measure.*` | package alias |
| `MEA-15` | `geometric_abstract_measure_theory` | `L1` first | `MEA-T52` through `MEA-T55` | `Proofs.Ai.Measure.Geometric`, `Proofs.Ai.Measure.Algebra` | long-term interface |
| `MEA-16` | `measure_public_closure_promotion` | `L3 Public closure` | `MEA-T56` | future `Mathlib.Measure.*` closure batch | promotion |
...
| `MEA-01` | set predicates, sigma-algebra closure laws, generated sigma algebra, Borel generator routes, pi-lambda and monotone-class evidence | topology basics for Borel routes | source-free module verify |
...
| `MEA-03` | outer measure laws, Caratheodory criterion, premeasure, semiring/ring/algebra extension evidence | `MEA-01`, `MEA-02` for restriction measure | source-free module verify or construction-interface audit |
| `MEA-04` | interval covers, Borel measure, completion, translation/scaling invariance, monotone function and distribution-function evidence | `MEA-03`, real-analysis and topology routes | interface audit before derived source |
...
| `MEA-08` | product sigma algebra, product measure existence and uniqueness, sigma-finiteness, sections, nonnegative and integrable function hypotheses | `MEA-01`, `MEA-02`, `MEA-07` | source-free module verify |
| `MEA-09` | measurable map, pushforward definition, distribution measures, measurable isomorphism, Jacobian or density evidence | `MEA-05`, `MEA-08`, `MEA-10` for density transformation | source-free module verify or interface audit |
| `MEA-10` | signed-measure, Hahn/Jordan, total variation, absolute continuity, Radon-Nikodym derivative, complex-measure evidence | `MEA-02`, `MEA-07` | source-free module verify or interface audit |
| `MEA-11` | Borel/Radon regularity, Vitali covering, density theorem, differentiation basis and topological hypotheses | `MEA-04`, `MEA-10`, topology compactness/regularity | interface audit |
| `MEA-12` | seminorm/norm evidence, quotient by a.e. equality, Minkowski, Holder, completeness, finite-measure inclusions | `MEA-07`, analysis normed-space routes | source-free module verify or interface audit |
| `MEA-13` | Borel, Radon, tightness, weak convergence, Portmanteau, Prokhorov, selection hypotheses | topology regularity/countability/compactness | interface audit |
| `MEA-14` | probability as finite measure with total mass one, independence via product measure, conditional expectation via Radon-Nikodym, recurrence and ergodic hypotheses | `MEA-08`, `MEA-10`, probability/statistics route cards | interface audit |
| `MEA-15` | Hausdorff measure, packing measure, coarea, area formula, measure algebra, Boolean algebra and classification evidence | `MEA-03`, `MEA-11`, topology and geometry routes | interface audit |
