...
- Progress:
  ...
  primitive-normalization plus
    ...
    constructs the same standard closure from primitive normalization
    providers, Frey-model component laws, direct Wiles/Ribet route laws,
    raw-realization evidence, and the no-raw-counterexample law, without
