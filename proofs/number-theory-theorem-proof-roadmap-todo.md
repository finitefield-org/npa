...
- Current L2 theorem coverage:
  ...
  - Completed L2 `Std.Nat` exponent selected-no-raw wrapper targets:
    `fermat_not_raw_counterexample_std_nat_exponent_from_selected_no_raw_facts`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_selected_no_raw_facts`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_selected_no_raw_facts`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_selected_no_raw_facts`,
    `fermat_last_theorem_std_nat_exponent_from_selected_no_raw_facts`, and
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_selected_no_raw_facts`
    specialize the selected no-raw boundary to `Std.Nat`, explicit `EqualInt`,
    and an explicit `ExponentAtLeastThree` predicate.
  - Completed L2 `Std.Nat` exponent ordered-field selected-no-raw wrapper
    targets:
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_selected_no_raw_facts`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_selected_no_raw_facts`,
    and
  ...
  - Completed L2 formula-level raw-primitive-provider closure targets for this batch:
    ...
    `fermat_positive_integer_solution_false_std_nat_exponent_from_raw_primitive_frey_route_provider`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_raw_primitive_frey_route_provider`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_raw_primitive_frey_route_provider`,
    `fermat_last_theorem_std_nat_exponent_from_raw_primitive_frey_route_provider`,
    and
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_raw_primitive_frey_route_provider`
  ...
  - Completed L2 formula-level primitive-provider closure targets for this batch:
    ...
    `fermat_positive_integer_solution_false_std_nat_exponent_from_primitive_frey_route_provider`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_primitive_frey_route_provider`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_primitive_frey_route_provider`,
    `fermat_last_theorem_std_nat_exponent_from_primitive_frey_route_provider`,
    and
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_primitive_frey_route_provider`
  ...
  - Completed L2 formula-level Frey-model/route-data closure targets for this batch:
    ...
    `fermat_positive_integer_solution_false_std_nat_exponent_from_frey_model_and_route_data`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_frey_model_and_route_data`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_frey_model_and_route_data`,
    `fermat_last_theorem_std_nat_exponent_from_frey_model_and_route_data`,
    and
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_frey_model_and_route_data`
  ...
  - Completed L2 formula-level primitive-normalization closure targets for this batch:
    ...
    `fermat_positive_integer_solution_false_std_nat_exponent_from_primitive_normalization_provider`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_primitive_normalization_provider`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_primitive_normalization_provider`,
    `fermat_last_theorem_std_nat_exponent_from_primitive_normalization_provider`,
    and
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_primitive_normalization_provider`
...
- Completed L2 raw-refutation primitive-provider reroute target:
  ...
  - Re-routed the remaining FLT semistable modularity inputs so route modularity
    and no-bridge laws are derived directly from `SemistableModularityData`;
    the FLT module source no longer calls
...
- Completed L2 `Std.Nat` exponent solution raw-primitive-Frey-route target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers
    ...
    `fermat_positive_integer_solution_false_std_nat_exponent_from_solution_raw_primitive_frey_route_provider`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_solution_raw_primitive_frey_route_provider`,
    and
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_solution_raw_primitive_frey_route_provider`.
  - These consume a solution-indexed raw-primitive-Frey-route provider together
    with raw-realization and no-raw-counterexample laws, construct the
...
- Completed L2 `Std.Nat` exponent global-raw-refutation-data component target:
  ...
  - Added formula-level positive-solution wrappers
    ...
    They construct a raw counterexample directly from
    `FermatPositiveSolutionData` and consume the selected no-counterexample
    provider through the global raw-refutation data.
  ...
  - These wrappers construct/project the raw-refutation package, specialize the
    ...
    formula-level or positive-integer solution plus a selected no-counterexample
    provider into contradiction. The ordered-field versions derive the needed
    `Positive -> Nonzero` law from the ordered-field bridge before consuming
    the same raw-refutation closure. They still consume
    `FermatGlobalRawRefutationData` and a selected no-counterexample provider;
    this is not an unconditional FLT proof.
...
- Completed L2 `Std.Nat` exponent global-normalization/route-law target:
  ...
  - These wrappers still assume the primitive-normalization provider families,
    ...
    listed below.
- Completed L2 `Std.Nat` exponent bridge-free no-counterexample-law target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free no-counterexample-law boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_no_counterexample_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_no_counterexample_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_no_counterexample_laws_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_no_counterexample_laws_bridge_free`.
...
- Completed L2 `Std.Nat` exponent bridge-free level-two-obstruction-law target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    ...
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_level_two_obstruction_laws_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_level_two_obstruction_laws_bridge_free`.
  - These wrappers still assume the bridge-free level-two-obstruction laws,
    route data, raw-realization provider, and no-raw translation law; the
    certified replacement of those inputs remains listed below.
- Completed L2 `Std.Nat` exponent bridge-free level-lowering-law target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free level-lowering-law boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_level_lowering_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_level_lowering_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_level_lowering_laws_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_level_lowering_laws_bridge_free`.
  - These wrappers still assume the bridge-free level-lowering laws,
    ...
    below.
- Completed L2 `Std.Nat` exponent bridge-free level-lowering-core-law target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free level-lowering-core-law boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_level_lowering_core_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_level_lowering_core_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_level_lowering_core_laws_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_level_lowering_core_laws_bridge_free`.
  - These wrappers still assume the bridge-free level-lowering core laws,
    level-two-obstruction laws, raw-realization provider, and no-raw
    translation law; the certified replacement of those inputs remains listed
    below.
- Completed L2 `Std.Nat` exponent bridge-free minimal-modularity-lifting-core
  target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free minimal-modularity-lifting-core boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_minimal_modularity_lifting_core_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_minimal_modularity_lifting_core_bridge_free`.
  - These wrappers still assume the minimal-modularity-lifting core inputs,
    level-lowering core laws, level-two-obstruction laws, raw-realization
    provider, and no-raw translation law; the certified replacement of those
    inputs remains listed below.
- Completed L2 `Std.Nat` exponent bridge-free semistable-assumptions-identity
  target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free semistable-assumptions identity boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_semistable_assumptions_identity_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_semistable_assumptions_identity_bridge_free`.
  - These wrappers still assume the semistable-assumptions identity inputs,
    modularity-lifting facts, level-lowering facts, level-two-obstruction laws,
    raw-realization provider, and no-raw translation law; the certified
    replacement of those inputs remains listed below.
- Completed L2 `Std.Nat` exponent bridge-free semistable-route-identity
  target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free semistable-route identity boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_semistable_route_identity_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_semistable_route_identity_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_semistable_route_identity_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_semistable_route_identity_bridge_free`.
  - These wrappers replace the explicit semistable-modularity route law with
    the bridge-free identity route. They still assume modularity-lifting facts,
...
- Completed L2 `Std.Nat` exponent bridge-free semistable-modularity-law
  target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free semistable-modularity-law boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_semistable_modularity_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_semistable_modularity_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_semistable_modularity_laws_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_semistable_modularity_laws_bridge_free`.
  - These wrappers still assume the modularity-lifting data,
    semistable-assumptions law, semistable route law, level-lowering facts,
    level-two-obstruction laws, raw-realization provider, and no-raw
    translation law; the certified replacement of those inputs remains listed
    below.
- Completed L2 `Std.Nat` exponent bridge-free modularity-lifting-law target:
  ...
  - These wrappers replace the packaged `ModularityLiftingData` input by
    ...
    and no-raw translation law; the certified replacement of those inputs
    remains listed below.
- Completed L2 `Std.Nat` exponent bridge-free modularity-conclusion-law target:
  - Added explicit `EqualInt` / `ExponentAtLeastThree` wrappers over the
    bridge-free modularity-conclusion-law boundary:
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_modularity_conclusion_laws_bridge_free`.
  - Added the ordered-field counterparts
    `fermat_positive_integer_global_elimination_data_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_positive_integer_solution_false_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_last_theorem_positive_integer_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_positive_arithmetic_solution_false_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_last_theorem_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_selected_positive_arithmetic_contradiction_law_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_global_elimination_data_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`,
    `fermat_positive_solution_false_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`, and
    `fermat_not_positive_solution_std_nat_exponent_from_ordered_field_modularity_conclusion_laws_bridge_free`.
  - These wrappers replace the selected `modularity_conclusion_of_curve`
    provider by curve-indexed residual-irreducible, local-condition,
    minimal-condition, and modularity-assumption providers plus the minimal
    modularity-lifting law. They still assume semistable route laws,
    level-lowering facts, level-two-obstruction laws, raw-realization provider,
    and no-raw translation law; the certified replacement of those inputs
    remains listed below.
