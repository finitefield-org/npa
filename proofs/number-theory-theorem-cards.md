...
| `NT-16` elliptic curves | `elliptic_curve_number_theory` | `L1 Evidence package` first; bounded group-law lemmas may become `L2`; unresolved conjectures are excluded from proof-corpus declarations | `Proofs.Ai.EllipticCurve.*` | bridge-interface, conditional | `--build-module Proofs.Ai.EllipticCurve.Basic`; `--module Proofs.Ai.EllipticCurve.Basic` |
...
| `NT-18` L-functions and Langlands interfaces | `l_functions_langlands_interfaces` | `L1 Evidence package` for proved interface fragments; broad conjectural functoriality is roadmap-only | `Proofs.Ai.NumberTheory.LFunction`, `Proofs.Ai.NumberTheory.ArtinL`, `Proofs.Ai.NumberTheory.HeckeL`, `Proofs.Ai.NumberTheory.AutomorphicL`, `Proofs.Ai.Langlands.Interface` | bridge-interface, excluded-conjecture, conditional | `--build-module Proofs.Ai.Langlands.Interface`; `--module Proofs.Ai.Langlands.Interface` |
...
| `NT-20` Iwasawa theory | `iwasawa_theory` | `L1 Evidence package`; main-conjecture-shaped claims are roadmap-only unless reformulated as named assumptions for conditional theorems | `Proofs.Ai.NumberTheory.Iwasawa.Basic`, `Proofs.Ai.NumberTheory.Iwasawa.MainConjecture`, `Proofs.Ai.NumberTheory.Iwasawa.EulerSystem` | bridge-interface, excluded-conjecture, conditional | `--build-module Proofs.Ai.NumberTheory.Iwasawa.Basic`; `--module Proofs.Ai.NumberTheory.Iwasawa.Basic` |
...
| Broad Langlands functoriality and correspondence claims | `NT-18` | Roadmap exclusion or proved `L1` named interface fragments | Individual proved fragments may be promoted only after source-free closure. |
